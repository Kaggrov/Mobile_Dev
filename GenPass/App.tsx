...
const App = () => {
  ...
  const generatePasswordString = (passLength: number) => {
    ...
    if (passProps.numbers) {
      characterList += digits;
    }
    if (passProps.symbols) {
      characterList += specialChars;
    }

    const pass = createPassword(characterList, passLength);
  ...
  return (
    <ScrollView keyboardShouldPersistTaps="handled">
      <SafeAreaView style={styles.appContainer}>
          ...
          <Formik
            ...
            {({
              ...
              <View style={styles.inputWrapper}>
                  ...
                  <BouncyCheckbox 
                    disableBuiltInState
                    isChecked={passProps.lower}
                    onPress={()=>setPassProps((prev)=>({
                      ...prev,
                      lower:!prev.lower
                    }))}
                    fillColor='#29AB87'
        ...
        {isPassGenerated ? <View style={[styles.card,styles.cardElevated]}>
